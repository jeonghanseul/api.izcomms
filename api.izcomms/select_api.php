...
<html>
	<head>
        ...
        <link rel="stylesheet" href="css/select_api.css">
	...
	<body>
    	<div class="admin_line">
        	<div class="admin_box">
                ...
                <div class="admin"><a href="./login/admin.php"><span><img src="img/admin.png" width="20px" height="20px"></span>관리페이지 이동</a></div>
                
                <div class="login"><a href="./login/logOut.php"><span><img src="img/login.png" width="20px" height="20px"></span>로그아웃</a></div>
            </div>
		</div>
		<div id="check_box">
			
			<div class="all">
				<input type="checkbox" id="allChk" class="styled-checkbox" value="" onClick="checkAll();"><label for="allChk">전체 선택</label>
			</div>
...
// 					echo " " .$page." / ".$pageNum;
        ...
        <!--
        <div class="footer">
        	<p>Copyright ⓒ IZ COMMS CORP All rights reserved.</p>
        </div>
        -->
	</body>
</html>